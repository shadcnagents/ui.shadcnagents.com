  ...
  return (
    <div className="mx-auto w-full max-w-lg space-y-8 p-8">
      ...
      <div className="space-y-3">
        ...
        <div className="flex">
          <span className="flex h-9 items-center rounded-l-md border border-r-0 border-border/60 bg-muted/30 px-3 text-xs text-muted-foreground">
            https://
          </span>
          <input
            value={inputValue}
            ...
            className="h-9 flex-1 border border-border/60 bg-transparent px-3 text-sm outline-none placeholder:text-muted-foreground/40 focus:border-foreground/20"
          />
      ...
      <div className="space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-9 w-full rounded-md border border-border/60 bg-transparent pl-9 pr-3 text-sm outline-none placeholder:text-muted-foreground/40 focus:border-foreground/20"
          />
          <kbd className="absolute right-3 top-1/2 -translate-y-1/2 rounded border border-border/40 bg-muted/30 px-1.5 py-0.5 text-[10px] text-muted-foreground/40">
            /
          </kbd>
        </div>
      </div>
