...
For example, you can ask an AI assistant to "Build a landing page using components from the shadcnagents registry" or "Find me a login form from the shadcn registry".
...
- Install the Cursor rules from the shadcnagents registry

### Work with Namespaces

- Show me components from shadcnagents registry
- Install @internal/auth-form
- Build me a landing page using hero, features and testimonials sections from the shadcnagents registry
