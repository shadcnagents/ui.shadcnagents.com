---
title: AI SDK Blocks
description: Overview of the Vercel AI SDK building blocks used across all patterns — generateText, streamText, useChat, tool, and agent.
---

Every pattern in shadcncloud is built on the Vercel AI SDK. This page covers the core building blocks and how they map to patterns.
