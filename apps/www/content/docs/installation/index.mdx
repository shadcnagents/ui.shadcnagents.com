...
For projects using shadcn CLI v3, you can configure the shadcncloud registry to install components directly via the command line.

#### Configure Registry

Add the shadcncloud registry to your `components.json` file:
...
npx shadcn@beta add @shadcncloud/text-gif

# Install multiple components
npx shadcn@beta add @shadcncloud/texture-card @shadcncloud/texture-button

# Search for components
npx shadcn@beta search @shadcncloud --query "texture-button"
```
